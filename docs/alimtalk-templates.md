...
```
[BnBiseo] 매니저 배정이 완료되었어요

#{propertyName} 청소에 #{managerName} 매니저가 배정되었어요.
...
#{propertyName} 청소가 시작되었어요. 작업 완료 후 점검 리포트를 보내드릴게요.
...
#{propertyName} 청소가 완료되었어요. 시설 점검 리포트를 확인하시고 다음 게스트를 맞이할 준비를 시작해보세요.
...
```
[BnBiseo] 청소 일정이 취소되었어요

#{propertyName} 청소 일정이 운영 사유로 취소되었어요.
...
```
[BnBiseo] 수리 견적이 도착했어요

#{propertyName} 수리 견적이 도착했어요.
견적 금액: #{quotedCost}원
방문 예정: #{scheduledDate} #{scheduledTime}

견적에 동의하시면 결제 후 방문 일정이 확정돼요.
...
#{propertyName} 수리가 완료되었어요. 조치 내용과 사진이 담긴 보고서를 확인해주세요.
...
```
[BnBiseo] 수리 일정이 취소되었어요

#{propertyName} 수리 일정이 운영 사유로 취소되었어요.
결제 금액은 영업일 3일 이내에 환불 처리됩니다.
