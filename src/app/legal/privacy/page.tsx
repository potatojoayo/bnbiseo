export default function PrivacyPage() {
  return (
    <div className="min-h-[100dvh] bg-white px-6 pt-8 pb-12 mx-auto max-w-[560px]">
      <h1 className="text-[22px] font-semibold text-[#222222] mb-6">개인정보처리방침</h1>
      ...
      <div className="flex flex-col gap-6 text-[14px] text-[#222222] leading-relaxed">
        ...
        <section>
          ...
          <div className="text-[#717171] flex flex-col gap-2">
            <div>
              <p className="font-medium text-[#222222]">필수 항목</p>
              <p>이메일 주소, 이름, 비밀번호</p>
            </div>
            <div>
              <p className="font-medium text-[#222222]">선택 항목</p>
              <p>전화번호, 숙소 주소</p>
            </div>
            <div>
              <p className="font-medium text-[#222222]">자동 수집 항목</p>
        ...
        <section>
          ...
          <div className="text-[#717171] flex flex-col gap-1">
        ...
        <section>
          ...
          <div className="rounded-lg bg-[#F7F7F7] px-4 py-3 mt-2 text-[13px] text-[#717171]">
            <p><span className="text-[#222222] font-medium">제공받는 자:</span> 토스페이먼츠</p>
            <p><span className="text-[#222222] font-medium">제공 항목:</span> 주문번호, 결제금액, 이메일</p>
            <p><span className="text-[#222222] font-medium">제공 목적:</span> 결제 처리 및 결제 사기 방지</p>
            <p><span className="text-[#222222] font-medium">보유 기간:</span> 결제 완료 후 5년</p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="rounded-lg bg-[#F7F7F7] px-4 py-3 text-[13px] text-[#717171]">
            <p><span className="text-[#222222] font-medium">성명:</span> 한효범</p>
            <p><span className="text-[#222222] font-medium">이메일:</span> potatojoayo@gmail.com</p>
          </div>
        </section>
