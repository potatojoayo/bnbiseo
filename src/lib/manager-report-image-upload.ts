...
export type UploadedManagerReportImage = {
  storagePath: string
...
export async function uploadManagerReportImage(
  cleaningId: string,
  assetId: string,
  file: File,
) {
  ...
  }>(`/manager/cleanings/${cleaningId}/report/upload-url`, {
    assetId,
    fileName: file.name,
  })
  ...
  } satisfies UploadedManagerReportImage
}
